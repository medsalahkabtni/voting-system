                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                if($_SESSION['status']==1){
                                    ...
                                    ?>
                                    <div class="g-recaptcha" data-sitekey="6LcrznkdAAAAADE-9TZYvP8iHV6Ong_Hx0MiBVRt"></div>
                                    <button style="padding: 5px; font-size: 15px; background-color: #3498db; color: white; border-radius: 5px;" name="submit" type="submit">Vote</button>
                                    <?php
                                }
                                ?>
                                </form>
